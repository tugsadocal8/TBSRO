...
namespace TBSRO
{
    public partial class Form13 : Form
    {
        ...
        private void btnOnayla_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand da = new OleDbCommand("INSERT INTO KoltukNo(VagonTuru,Vagon,KoltukNo) VALUES('" + nesne.VagonTuru3.Text + "','" + nesne.Vagon8.Text + "','" + selectedButton.TabIndex + "')", baglantı);
        ...
        private void Kapatma7()
        {

            Form4 fm4 = new Form4();
            baglantı.Open();
            OleDbCommand da = new OleDbCommand("SELECT VagonTuru,Vagon,KoltukNo FROM KoltukNo WHERE VagonTuru='" + fm4.VagonTuru3.Text + "' and Vagon ='" + fm4.Vagon8.Text + "' ", baglantı);
            OleDbDataReader oku1 = null;
