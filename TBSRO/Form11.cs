...
namespace TBSRO
{
    public partial class Form11 : Form
    {
        ...
        private void btnOnayla_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand da = new OleDbCommand("INSERT INTO KoltukNo(VagonTuru,Vagon,KoltukNo) VALUES('" + nesne.VagonTuru2.Text + "','" + nesne.Vagon6.Text + "','" + selectedButton.TabIndex + "')", baglantı);
        ...
        private void Kapatma6()
        {

            Form4 fm4 = new Form4();
            baglantı.Open();
            OleDbCommand da = new OleDbCommand("SELECT VagonTuru,Vagon,KoltukNo FROM KoltukNo WHERE VagonTuru='" + fm4.VagonTuru2.Text + "' and Vagon ='" + fm4.Vagon6.Text + "' ", baglantı);
            OleDbDataReader oku1 = null;
