...
namespace TBSRO
{
    public partial class Form8 : Form
    {
        ...
        private void Kapatma3()
        {
            Form4 fm4 = new Form4();
            baglantı.Open();
            OleDbCommand da = new OleDbCommand("SELECT VagonTuru,Vagon,KoltukNo FROM KoltukNo WHERE VagonTuru='" + fm4.VagonTuru1.Text + "' and Vagon ='" + fm4.Vagon3.Text + "' ", baglantı);
        ...
        private void btnOnayla_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand da = new OleDbCommand("INSERT INTO KoltukNo(VagonTuru,Vagon,KoltukNo) VALUES('" + nesne.VagonTuru1.Text + "','" + nesne.Vagon3.Text + "','" + selectedButton.TabIndex + "')", baglantı);
            OleDbDataReader oku1 = null;
            oku1 = da.ExecuteReader();
            while (oku1.Read())
            {
