...
namespace TBSRO
{
    public partial class Form12 : Form
    {
        ...
        private void Kapatma6()
        {
            ...
            Form4 fm4 = new Form4();
            baglantı.Open();
            OleDbCommand da = new OleDbCommand("SELECT VagonTuru,Vagon,KoltukNo FROM KoltukNo WHERE VagonTuru='" + fm4.VagonTuru2.Text + "' and Vagon ='" + fm4.Vagon7.Text + "' ", baglantı);
        ...
        private void btnOnayla_Click_1(object sender, EventArgs e)
        {
            ...
            OleDbCommand da = new OleDbCommand("INSERT INTO KoltukNo(VagonTuru,Vagon,KoltukNo) VALUES('" + nesne.VagonTuru2.Text + "','" + nesne.Vagon7.Text + "','" + selectedButton.TabIndex + "')", baglantı);
            OleDbDataReader oku1 = null;
            oku1 = da.ExecuteReader();
            while (oku1.Read())
            {
